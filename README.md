...
| Шрифт | Высота (строк) | Исходная высота | Строки под выносные элементы |
|-------|---------------|----------------|-------------|
| Small | 10 | 8 | 2 строки сверху + 1 снизу |
| Small Bold | 10 | 8 | 2 строки сверху + 1 снизу |
| Big | 15 | 13 | 2 строки сверху + 2 снизу |
